...
** Demystify Type Theory
  ...
  - [ ] Demystify terminology.
    ...
    - [ ] Demystify "existential polymorphism".
      - See [[http://lambda-the-ultimate.org/node/4865#comment-78185][Andreas Rossberg's comment(s) on Lambda the Ultimate]]. asdf
        #+begin_quote
...
** Demystify Name binding
  ...
  - =bound=
    - [ ] [[https://www.schoolofhaskell.com/user/edwardk/bound][Edward Kmett on Bound]] 
    - [ ] [[https://gist.github.com/cartazio/5727196][Higher order bound]]
  - =unbound=
...
** Demystify Compiler Correctness
