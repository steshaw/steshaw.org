* Now
  ...
  - BabyML
  - Lightyear 
    - patch with chainl/chainl1
    - add [[https://github.com/ekmett/parsers/blob/master/src/Text/Parser/Expression.hs][expression helper]]?
  - PFPL (book)
...
** So you wanna learn Type Theory
  ...
  - [ ] Read Frank Pfenning's [[http://www.cs.cmu.edu/~fp/courses/15317-f09/schedule.html][lectures notes on Constructive Logic]].
    - at Lecture 4, "Proofs as Programs"
