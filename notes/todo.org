...
** Demystify Idris
  ...
  - [ ] Extensible records in Idris
    - https://github.com/jmars/Records
    - https://twitter.com/edwinbrady/status/465824408838602752
...
*** The Theory
  ...
  - Conor's Frank PL, "Do Be Do Be Do"
    - http://homepages.inf.ed.ac.uk/slindley/papers/frankly-draft-july2016.pdf
...
** Demystify Category Theory
  ...
  - Resources for learning Categories by Peter Smith
    ...
    - http://www.logicmatters.net/tyl/category-theory/
...
** Demystify Logic
  ...
  - [[http://www.logicmatters.net/tyl/][Teach Yourself Logic: A Study Guide]] Peter Smith.
...
** Demystify Compilers
  ...
  - [-] [[https://github.com/steshaw/babyml][BabyML]]
    - Use Haskell, Idris or OCaml.
    ...
    - [X] http://lucacardelli.name/Papers/CompilingML.A4.pdf
    ...
    - [ ] [[http://homepages.inf.ed.ac.uk/wadler/papers/pattern/pattern.pdf][Derivation of a Pattern-Matching Compiler]]
    ...
    - http://www.mpi-sws.org/~rossberg/hamlet/
    - [X] http://pauillac.inria.fr/~xleroy/talks/zam-kazam05.pdf
    - http://www.nimblemachines.com/zinc-abstract-machine/
  - [[#BabyIdris]]
  - Main outline
  ...
  - Another skeleton:
    ...
    - Backends:
      ...
      - "transpile" to C/JS/Java.
      - Compile to machine code: x86 / x86-64 / x86-64 in with 32 bit pointers.
      - Compile to JVM.
      - Compile to dotnet/CLR/CLI.
  ...
  - Would be nice to implement compilers with efficient nanopasses.
    + Perhaps possible in Haskell via datatypes a la carte and recursion schemes.
    + Seems that datatypes a la carte is not possible in Idris... Can it be fixed?
  - Courses:
    ...
    - http://cs.mcgill.ca/~cs520/2015/
    - https://www.cs.princeton.edu/courses/archive/spring12/cos320/schedule.html
...
** Lisp/Scheme Implementation
  ...
  - https://github.com/jsiek/Essentials-of-Compilation (book)
  - https://github.com/cgswords/sgc
  ...
  - Other Lispy/Schemey implementations:
    - http://orchid-hybrid.github.io/2014/10/10/notes-on-compilers/
...
*** Swift parser for Haskell
  ...
  - Sigh, language-swift-quote is stalled because of ambiguities in
    the grammar. Revisit now Swift 3.0 has been released?
