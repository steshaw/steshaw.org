...
** Idris
  ...
  - Get -Wall -Wwarn-tabs happening.
    - Noticing many errors with Intero. Need to turn on GHC warnings. 
    - There are many non-exhaustive patterns warnings!
    - -Werror already turns on with "CI" flag.
